...
@section('content')
    <section class="breadcrumb-section section-b-space" style="background-color: white; height: 100vh; display: flex; justify-content: center; align-items: center; overflow: hidden;">
        ...
        <div class="container text-center">
            <div class="row">
                <div class="col-12">
                    <h2 class="error-subtitle">OOPS! SESSION EXPIRED</h2>
                    <h1 class="error-title">419</h1>
                    <p class="error-message">WE ARE SORRY, BUT YOUR SESSION HAS EXPIRED. PLEASE REFRESH AND TRY AGAIN.</p>
